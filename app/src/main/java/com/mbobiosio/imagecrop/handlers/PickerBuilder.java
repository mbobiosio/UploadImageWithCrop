...
public class PickerBuilder {
    ...
    public PickerBuilder(Activity activity, int type)
    {
        ...
        pickerManager = (type == PickerBuilder.SELECT_FROM_GALLERY) ? new ImageManager(activity) : new CameraManager(activity);
    ...
    public void start()
    {
        ...
        Holder.getInstance().setPickerManager(pickerManager);
